  ...
  return (
    <>
      ...
      <div className="flex gap-4 items-center">
        <FileInput
          // disabled={stateFileOne == "EN PROCESO" || view == 2 ? true : false}
          disabled
          openRef={openRef}
          className="w-full"
      ...
      <div className="flex gap-4 items-center">
        <FileInput
          ...
          className="w-full"
          leftSection={<RiInboxUnarchiveFill />}
          label="Copia literal de las unidades a independizar"
          placeholder="Copia literal de las unidades a independizar"
          leftSectionPointerEvents="none"
          accept="application/pdf"
          onChange={(file) =>
